    ...
    public partial class SearchManagementClient : ServiceClient<SearchManagementClient>, ISearchManagementClient, IAzureClient
    {
        ...
        public async Task<AzureOperationResponse<QuotaUsageResult>> UsageBySubscriptionSkuWithHttpMessagesAsync(string location, string skuName, SearchManagementRequestOptions searchManagementRequestOptions = default(SearchManagementRequestOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "UsageBySubscriptionSku", tracingParameters);
            }
            // Construct URL
            ...
            if (clientRequestId != null)
            {
                ...
                _httpRequest.Headers.TryAddWithoutValidation("x-ms-client-request-id", SafeJsonConvert.SerializeObject(clientRequestId, SerializationSettings).Trim('"'));
            }
            ...
            // Create Result
            var _result = new AzureOperationResponse<QuotaUsageResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<QuotaUsageResult>(_responseContent, DeserializationSettings);
                }
