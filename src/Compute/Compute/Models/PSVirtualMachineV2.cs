...
using Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301;
...
{
    public class PSVirtualMachineV2 : PSOperation
    {
        ...
        // public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.VirtualMachine GetSDKModel()
        // {
        //     return new PowerShell.Cmdlets.ComputeClient.Models.Api20220301.VirtualMachine{
        //         BootDiagnosticEnabled = this.DiagnosticsProfile.BootDiagnostics.Enabled,
        //         BootDiagnosticStorageUri = this.DiagnosticsProfile.BootDiagnostics.StorageUri,

        //         HardwareProfileVMSize = this.HardwareProfile.VmSize,
        //         VMSizePropertyVcpUsAvailable = this.HardwareProfile.VmSizeProperties.VCPUsAvailable,
        //         VMSizePropertyVcpUsPerCore = this.HardwareProfile.VmSizeProperties.VCPUsPerCore,

        //         ImageReferenceId = this.StorageProfile.ImageReference.Id,
        //         ImageReferenceCommunityGalleryImageId = this.StorageProfile.ImageReference.CommunityGalleryImageId,
        //         ImageReferenceOffer = this.StorageProfile.ImageReference.Offer,
        //         ImageReferencePublisher = this.StorageProfile.ImageReference.Publisher,
        //         ImageReferenceSharedGalleryImageId = this.StorageProfile.ImageReference.SharedGalleryImageId,
        //         ImageReferenceSku = this.StorageProfile.ImageReference.Sku,
        //         ImageReferenceVersion = this.StorageProfile.ImageReference.Version,
        //     };
        // }
    }
}
