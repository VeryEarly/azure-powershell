...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime
{
    ...
    {
        Task Validate(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IEventListener listener);
    }
    ...
    internal static partial class Extensions
    {
        ...
        public static async Task AssertNotNull(this IEventListener instance, string parameterName, object value)
        {
            if (value == null)
            {
                await instance.Signal(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Events.ValidationWarning, instance.Token, () => new EventData { Id = Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Events.ValidationWarning, Message = $"'{parameterName}' should not be null", Parameter = parameterName, Cancel = instance.Cancel });
            }
        }
        ...
        {
            await (inst as Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IValidates)?.Validate(instance);
        }
