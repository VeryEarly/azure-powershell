...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.PowerShell
{
    ...
    public class AsyncOperationResponse
    {
        ...
        internal AsyncOperationResponse(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject json)
        {
            // pull target 
            { Target = If(json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonString>("target"), out var _v) ? (string)_v : (string)Target; }
        }
        ...
        public static AsyncOperationResponse FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject json ? new AsyncOperationResponse(json) : null;
        }
        ...
        public static AsyncOperationResponse FromJsonString(string jsonText) => FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode.Parse(jsonText));
    ...
    public partial class AsyncOperationResponseTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static bool CanConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ...
                return true == text?.StartsWith("{") && true == text?.EndsWith("}") && Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode.Parse(text).Type == Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonType.Object;
            }
            catch
            {
