...
using Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
            ...
            if (value is System.Collections.Hashtable hashtable)
            {
                ...
                return Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.JsonSerializable.ToJson(dict, null);
            }
