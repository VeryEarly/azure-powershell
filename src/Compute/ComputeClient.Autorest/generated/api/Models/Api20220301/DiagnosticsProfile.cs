...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301
{
    ...
    public partial class DiagnosticsProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IDiagnosticsProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IDiagnosticsProfileInternal
    {

        /// <summary>Backing field for <see cref="BootDiagnostic" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnostics _bootDiagnostic;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnostics BootDiagnostic { get => (this._bootDiagnostic = this._bootDiagnostic ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.BootDiagnostics()); set => this._bootDiagnostic = value; }
        ...
        public bool? BootDiagnosticEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnosticsInternal)BootDiagnostic).Enabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnosticsInternal)BootDiagnostic).Enabled = value ?? default(bool); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Inlined)]
        public string BootDiagnosticStorageUri { get => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnosticsInternal)BootDiagnostic).StorageUri; set => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnosticsInternal)BootDiagnostic).StorageUri = value ?? null; }

        /// <summary>Internal Acessors for BootDiagnostic</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnostics Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IDiagnosticsProfileInternal.BootDiagnostic { get => (this._bootDiagnostic = this._bootDiagnostic ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.BootDiagnostics()); set { {_bootDiagnostic = value;} } }
...

    {
        ...
        /// of the VM from the hypervisor.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IBootDiagnostics BootDiagnostic { get; set; }
        /// <summary>Whether boot diagnostics should be enabled on the Virtual Machine.</summary>
        bool? BootDiagnosticEnabled { get; set; }
        /// <summary>
        /// Uri of the storage account to use for placing the console output and screenshot. <br><br>If storageUri is not specified
