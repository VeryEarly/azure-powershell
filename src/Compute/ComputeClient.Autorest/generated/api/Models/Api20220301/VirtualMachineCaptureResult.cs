...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301
{
    ...
    public partial class VirtualMachineCaptureResult :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVirtualMachineCaptureResultInternal,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IValidates
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVirtualMachineCaptureResultInternal.ContentVersion { get => this._contentVersion; set { {_contentVersion = value;} } }

        /// <summary>Internal Acessors for Parameter</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVirtualMachineCaptureResultInternal.Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Any()); set { {_parameter = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny[] Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVirtualMachineCaptureResultInternal.Resource { get => this._resource; set { {_resource = value;} } }

        /// <summary>Internal Acessors for Schema</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVirtualMachineCaptureResultInternal.Schema { get => this._schema; set { {_schema = value;} } }

        /// <summary>Backing field for <see cref="Parameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny _parameter;

        /// <summary>parameters of the captured virtual machine</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny Parameter { get => (this._parameter = this._parameter ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Any()); }

        /// <summary>Backing field for <see cref="Resource" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny[] _resource;

        /// <summary>a list of resource items of the captured virtual machine</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny[] Resource { get => this._resource; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISubResource
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny Parameter { get;  }
        /// <summary>a list of resource items of the captured virtual machine</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny) })]
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny[] Resource { get;  }
        /// <summary>the schema of the captured virtual machine</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Info(
        Required = false,
        ReadOnly = true,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISubResourceInternal
    {
        ...
        /// <summary>parameters of the captured virtual machine</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny Parameter { get; set; }
        /// <summary>a list of resource items of the captured virtual machine</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.IAny[] Resource { get; set; }
        /// <summary>the schema of the captured virtual machine</summary>
