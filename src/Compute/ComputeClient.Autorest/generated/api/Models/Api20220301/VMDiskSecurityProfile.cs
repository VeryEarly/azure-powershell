...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301
{
    ...
    public partial class VMDiskSecurityProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMDiskSecurityProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMDiskSecurityProfileInternal
    {
        ...
        public string DiskEncryptionSetId { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISubResourceInternal)DiskEncryptionSet).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISubResourceInternal)DiskEncryptionSet).Id = value ?? null; }

        /// <summary>Internal Acessors for DiskEncryptionSet</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISubResource Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMDiskSecurityProfileInternal.DiskEncryptionSet { get => (this._diskEncryptionSet = this._diskEncryptionSet ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.SubResource()); set { {_diskEncryptionSet = value;} } }

        /// <summary>Backing field for <see cref="SecurityEncryptionType" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.SecurityEncryptionTypes? _securityEncryptionType;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.SecurityEncryptionTypes? SecurityEncryptionType { get => this._securityEncryptionType; set => this._securityEncryptionType = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.SecurityEncryptionTypes? SecurityEncryptionType { get; set; }
