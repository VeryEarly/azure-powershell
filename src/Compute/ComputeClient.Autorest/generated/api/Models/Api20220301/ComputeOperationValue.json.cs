...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301
{
    ...
    public partial class ComputeOperationValue
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject into a new instance of <see cref="ComputeOperationValue" />.
        /// </summary>
        ...
        internal ComputeOperationValue(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject json)
        {
            ...
            {_display = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject>("display"), out var __jsonDisplay) ? Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ComputeOperationValueDisplay.FromJson(__jsonDisplay) : Display;}
            {_origin = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonString>("origin"), out var __jsonOrigin) ? (string)__jsonOrigin : (string)Origin;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IComputeOperationValue.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IComputeOperationValue.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IComputeOperationValue FromJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject json ? new ComputeOperationValue(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="ComputeOperationValue" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ComputeOperationValue" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._display ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode) this._display.ToJson(null,serializationMode) : null, "display" ,container.Add );
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._origin)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Json.JsonString(this._origin.ToString()) : null, "origin" ,container.Add );
            }
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.SerializationMode.IncludeReadOnly))
            {
