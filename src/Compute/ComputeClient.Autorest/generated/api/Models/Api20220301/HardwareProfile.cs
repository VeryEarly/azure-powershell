...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301
{
    ...
    public partial class HardwareProfile :
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IHardwareProfile,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IHardwareProfileInternal
    {

        /// <summary>Internal Acessors for VMSizeProperty</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMSizeProperties Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IHardwareProfileInternal.VMSizeProperty { get => (this._vMSizeProperty = this._vMSizeProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.VMSizeProperties()); set { {_vMSizeProperty = value;} } }

        /// <summary>Backing field for <see cref="VMSize" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.VirtualMachineSizeTypes? _vMSize;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.VirtualMachineSizeTypes? VMSize { get => this._vMSize; set => this._vMSize = value; }

        /// <summary>Backing field for <see cref="VMSizeProperty" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMSizeProperties _vMSizeProperty;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMSizeProperties VMSizeProperty { get => (this._vMSizeProperty = this._vMSizeProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.VMSizeProperties()); set => this._vMSizeProperty = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Inlined)]
        public int? VMSizePropertyVcpUsPerCore { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMSizePropertiesInternal)VMSizeProperty).VCpUsPerCore; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMSizePropertiesInternal)VMSizeProperty).VCpUsPerCore = value ?? default(int); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.VirtualMachineSizeTypes) })]
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.VirtualMachineSizeTypes? VMSize { get; set; }
        /// <summary>
        /// Specifies the number of vCPUs available for the VM. <br><br> When this property is not specified in the request body the
        /// default behavior is to set it to the value of vCPUs available for that VM size exposed in api response of [List all available
        /// virtual machine sizes in a region](https://docs.microsoft.com/en-us/rest/api/compute/resource-skus/list) .
...

    {
        ...
        /// in [VM Customization](https://aka.ms/vmcustomization) for more details.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVMSizeProperties VMSizeProperty { get; set; }
        /// <summary>
        /// Specifies the number of vCPUs available for the VM. <br><br> When this property is not specified in the request body the
        /// default behavior is to set it to the value of vCPUs available for that VM size exposed in api response of [List all available
        /// virtual machine sizes in a region](https://docs.microsoft.com/en-us/rest/api/compute/resource-skus/list) .
