...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301
{
    ...
    public partial class Usage :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageName Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageInternal.Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.UsageName()); set { {_name = value;} } }

        /// <summary>Internal Acessors for Unit</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageInternal.Unit { get => this._unit; set { {_unit = value;} } }

        /// <summary>Backing field for <see cref="Name" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageName _name;

        /// <summary>The name of the type of usage.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageName Name { get => (this._name = this._name ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.UsageName()); set => this._name = value; }
        ...
        public string NameLocalizedValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageNameInternal)Name).LocalizedValue; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageNameInternal)Name).LocalizedValue = value ?? null; }

        /// <summary>The name of the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Inlined)]
        public string NameValue { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageNameInternal)Name).Value; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageNameInternal)Name).Value = value ?? null; }
...

    {
        ...
        long Limit { get; set; }
        /// <summary>The name of the type of usage.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IUsageName Name { get; set; }
        /// <summary>The localized name of the resource.</summary>
        string NameLocalizedValue { get; set; }
        /// <summary>The name of the resource.</summary>
        string NameValue { get; set; }
