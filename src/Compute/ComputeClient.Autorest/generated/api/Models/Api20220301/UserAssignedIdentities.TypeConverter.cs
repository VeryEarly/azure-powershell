...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301
{
    ...
    public partial class UserAssignedIdentitiesTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// an instance of <see cref="UserAssignedIdentities" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUserAssignedIdentities ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUserAssignedIdentities).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
