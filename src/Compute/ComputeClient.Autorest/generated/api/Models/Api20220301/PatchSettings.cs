...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301
{
    ...
    public partial class PatchSettings :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchSettings,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchSettingsInternal
    {

        /// <summary>Backing field for <see cref="AssessmentMode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsPatchAssessmentMode? _assessmentMode;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsPatchAssessmentMode? AssessmentMode { get => this._assessmentMode; set => this._assessmentMode = value; }

        /// <summary>Backing field for <see cref="AutomaticByPlatformSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IWindowsVMGuestPatchAutomaticByPlatformSettings _automaticByPlatformSetting;

        /// <summary>
        /// Specifies additional settings for patch mode AutomaticByPlatform in VM Guest Patching on Windows.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IWindowsVMGuestPatchAutomaticByPlatformSettings AutomaticByPlatformSetting { get => (this._automaticByPlatformSetting = this._automaticByPlatformSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.WindowsVMGuestPatchAutomaticByPlatformSettings()); set => this._automaticByPlatformSetting = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IWindowsVMGuestPatchAutomaticByPlatformSettings Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchSettingsInternal.AutomaticByPlatformSetting { get => (this._automaticByPlatformSetting = this._automaticByPlatformSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.WindowsVMGuestPatchAutomaticByPlatformSettings()); set { {_automaticByPlatformSetting = value;} } }

        /// <summary>Backing field for <see cref="PatchMode" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsVMGuestPatchMode? _patchMode;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsVMGuestPatchMode? PatchMode { get => this._patchMode; set => this._patchMode = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsPatchAssessmentMode? AssessmentMode { get; set; }
        /// <summary>
        /// Specifies the reboot setting for all AutomaticByPlatform patch installation operations.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsVMGuestPatchMode? PatchMode { get; set; }
...

    {
        ...
        /// Specifies additional settings for patch mode AutomaticByPlatform in VM Guest Patching on Windows.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IWindowsVMGuestPatchAutomaticByPlatformSettings AutomaticByPlatformSetting { get; set; }
        /// <summary>
        /// Specifies the reboot setting for all AutomaticByPlatform patch installation operations.
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.WindowsVMGuestPatchAutomaticByPlatformRebootSetting? AutomaticByPlatformSettingRebootSetting { get; set; }
