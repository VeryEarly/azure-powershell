...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301
{
    ...
    public partial class LinuxConfiguration :
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxConfiguration,
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxConfigurationInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettings Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxConfigurationInternal.PatchSetting { get => (this._patchSetting = this._patchSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.LinuxPatchSettings()); set { {_patchSetting = value;} } }

        /// <summary>Internal Acessors for PatchSettingAutomaticByPlatformSetting</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxVMGuestPatchAutomaticByPlatformSettings Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxConfigurationInternal.PatchSettingAutomaticByPlatformSetting { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettingsInternal)PatchSetting).AutomaticByPlatformSetting; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettingsInternal)PatchSetting).AutomaticByPlatformSetting = value; }

        /// <summary>Internal Acessors for Ssh</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshConfiguration Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxConfigurationInternal.Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.SshConfiguration()); set { {_ssh = value;} } }

        /// <summary>Backing field for <see cref="PatchSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettings _patchSetting;

        /// <summary>[Preview Feature] Specifies settings related to VM Guest Patching on Linux.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettings PatchSetting { get => (this._patchSetting = this._patchSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.LinuxPatchSettings()); set => this._patchSetting = value; }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxPatchAssessmentMode? PatchSettingAssessmentMode { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettingsInternal)PatchSetting).AssessmentMode; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettingsInternal)PatchSetting).AssessmentMode = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxPatchAssessmentMode)""); }
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxVMGuestPatchMode? PatchSettingPatchMode { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettingsInternal)PatchSetting).PatchMode; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettingsInternal)PatchSetting).PatchMode = value ?? ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxVMGuestPatchMode)""); }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshConfiguration _ssh;

        /// <summary>Specifies the ssh key configuration for a Linux OS.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshConfiguration Ssh { get => (this._ssh = this._ssh ?? new Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.SshConfiguration()); set => this._ssh = value; }

        /// <summary>The list of SSH public keys used to authenticate with linux based VMs.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Origin(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.PropertyOrigin.Inlined)]
        public Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshPublicKey[] SshPublicKey { get => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshConfigurationInternal)Ssh).PublicKey; set => ((Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshConfigurationInternal)Ssh).PublicKey = value ?? null /* arrayOf */; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxVMGuestPatchAutomaticByPlatformRebootSetting? AutomaticByPlatformSettingRebootSetting { get; set; }
        /// <summary>Specifies whether password authentication should be disabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxPatchAssessmentMode? PatchSettingAssessmentMode { get; set; }
        /// <summary>
        /// Specifies the mode of VM Guest Patching to IaaS virtual machine or virtual machines associated to virtual machine scale
        /// set with OrchestrationMode as Flexible.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - The virtual machine's
        /// default patching configuration is used. <br /><br /> **AutomaticByPlatform** - The virtual machine will be automatically
        ...
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.LinuxVMGuestPatchMode? PatchSettingPatchMode { get; set; }
        /// <summary>
        /// Indicates whether virtual machine agent should be provisioned on the virtual machine. <br><br> When this property is not
        /// specified in the request body, default behavior is to set it to true. This will ensure that VM Agent is installed on the
        /// VM so that extensions can be added to the VM later.
...

    {
        ...
        bool? DisablePasswordAuthentication { get; set; }
        /// <summary>[Preview Feature] Specifies settings related to VM Guest Patching on Linux.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxPatchSettings PatchSetting { get; set; }
        /// <summary>
        /// Specifies the mode of VM Guest Patch Assessment for the IaaS virtual machine.<br /><br /> Possible values are:<br /><br
        /// /> **ImageDefault** - You control the timing of patch assessments on a virtual machine. <br /><br /> **AutomaticByPlatform**
        /// - The platform will trigger periodic patch assessments. The property provisionVMAgent must be true.
        ...
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ILinuxVMGuestPatchAutomaticByPlatformSettings PatchSettingAutomaticByPlatformSetting { get; set; }
        /// <summary>
        /// Specifies the mode of VM Guest Patching to IaaS virtual machine or virtual machines associated to virtual machine scale
        /// set with OrchestrationMode as Flexible.<br /><br /> Possible values are:<br /><br /> **ImageDefault** - The virtual machine's
        /// default patching configuration is used. <br /><br /> **AutomaticByPlatform** - The virtual machine will be automatically
        ...
        bool? ProvisionVMAgent { get; set; }
        /// <summary>Specifies the ssh key configuration for a Linux OS.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshConfiguration Ssh { get; set; }
        /// <summary>The list of SSH public keys used to authenticate with linux based VMs.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.ISshPublicKey[] SshPublicKey { get; set; }
