...
namespace Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType None = @"None";

        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType SystemAssigned = @"SystemAssigned";

        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType SystemAssignedUserAssigned = @"SystemAssigned, UserAssigned";

        public static Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType UserAssigned = @"UserAssigned";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType e1, Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Support.ResourceIdentityType e2)
        {
            return !e2.Equals(e1);
        }
