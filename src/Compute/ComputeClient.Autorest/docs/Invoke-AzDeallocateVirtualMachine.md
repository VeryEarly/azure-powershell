...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/invoke-azdeallocatevirtualmachine
schema: 2.0.0
---

# Invoke-AzDeallocateVirtualMachine
...
### Deallocate (Default)
```
Invoke-AzDeallocateVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-Hibernate] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeallocateViaIdentity
```
Invoke-AzDeallocateVirtualMachine -InputObject <IComputeClientIdentity> [-Hibernate]
