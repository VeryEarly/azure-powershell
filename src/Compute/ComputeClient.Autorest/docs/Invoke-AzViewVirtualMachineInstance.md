...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/invoke-azviewvirtualmachineinstance
schema: 2.0.0
---

# Invoke-AzViewVirtualMachineInstance
...
### View (Default)
```
Invoke-AzViewVirtualMachineInstance -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### ViewViaIdentity
```
Invoke-AzViewVirtualMachineInstance -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ComputeClient.Models.Api20220301.IVirtualMachineInstanceView
