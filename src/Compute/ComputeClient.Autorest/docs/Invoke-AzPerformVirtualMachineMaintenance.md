...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/invoke-azperformvirtualmachinemaintenance
schema: 2.0.0
---

# Invoke-AzPerformVirtualMachineMaintenance
...
### Perform (Default)
```
Invoke-AzPerformVirtualMachineMaintenance -ResourceGroupName <String> -VMName <String>
...
### PerformViaIdentity
```
Invoke-AzPerformVirtualMachineMaintenance -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>]
...
Parameter Sets: PerformViaIdentity
Aliases:
