...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/convert-azvirtualmachinetomanageddisk
schema: 2.0.0
---

# Convert-AzVirtualMachineToManagedDisk
...
### Convert (Default)
```
Convert-AzVirtualMachineToManagedDisk -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ConvertViaIdentity
```
Convert-AzVirtualMachineToManagedDisk -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>]
