...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/invoke-azredeployvirtualmachine
schema: 2.0.0
---

# Invoke-AzRedeployVirtualMachine
...
### Redeploy (Default)
```
Invoke-AzRedeployVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RedeployViaIdentity
```
Invoke-AzRedeployVirtualMachine -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>] [-AsJob]
