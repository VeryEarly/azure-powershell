...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/restart-azvirtualmachine
schema: 2.0.0
---

# Restart-AzVirtualMachine
...
### Restart (Default)
```
Restart-AzVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RestartViaIdentity
```
Restart-AzVirtualMachine -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
