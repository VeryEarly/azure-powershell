...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/invoke-azreapplyvirtualmachine
schema: 2.0.0
---

# Invoke-AzReapplyVirtualMachine
...
### Reapply (Default)
```
Invoke-AzReapplyVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ReapplyViaIdentity
```
Invoke-AzReapplyVirtualMachine -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>] [-AsJob]
...
Parameter Sets: ReapplyViaIdentity
Aliases:
