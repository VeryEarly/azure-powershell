...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/remove-azvirtualmachine
schema: 2.0.0
---

# Remove-AzVirtualMachine
...
### Delete (Default)
```
Remove-AzVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
...
### DeleteViaIdentity
```
Remove-AzVirtualMachine -InputObject <IComputeClientIdentity> [-ForceDeletion] [-DefaultProfile <PSObject>]
