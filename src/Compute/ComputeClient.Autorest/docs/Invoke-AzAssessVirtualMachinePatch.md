...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/invoke-azassessvirtualmachinepatch
schema: 2.0.0
---

# Invoke-AzAssessVirtualMachinePatch
...
### Assess (Default)
```
Invoke-AzAssessVirtualMachinePatch -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### AssessViaIdentity
```
Invoke-AzAssessVirtualMachinePatch -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>] [-AsJob]
