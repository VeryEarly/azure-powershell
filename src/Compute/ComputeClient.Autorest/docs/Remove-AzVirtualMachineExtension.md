...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/remove-azvirtualmachineextension
schema: 2.0.0
---

# Remove-AzVirtualMachineExtension
...
### Delete (Default)
```
Remove-AzVirtualMachineExtension -ResourceGroupName <String> -VMExtensionName <String> -VMName <String>
...
### DeleteViaIdentity
```
Remove-AzVirtualMachineExtension -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>] [-AsJob]
