...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/update-azvirtualmachineextension
schema: 2.0.0
---

# Update-AzVirtualMachineExtension
...
```
Update-AzVirtualMachineExtension -ResourceGroupName <String> -VMExtensionName <String> -VMName <String>
 ...
 [-SuppressFailure] [-Tag <Hashtable>] [-Type <String>] [-TypeHandlerVersion <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzVirtualMachineExtension -InputObject <IComputeClientIdentity> [-AutoUpgradeMinorVersion]
 [-EnableAutomaticUpgrade] [-ForceUpdateTag <String>] [-ProtectedSetting <IAny>]
 [-ProtectedSettingsFromKeyVault <IAny>] [-Publisher <String>] [-Setting <IAny>] [-SuppressFailure]
