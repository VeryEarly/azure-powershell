...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/set-azvirtualmachineextension
schema: 2.0.0
---

# Set-AzVirtualMachineExtension
...
```
Set-AzVirtualMachineExtension -ResourceGroupName <String> -VMExtensionName <String> -VMName <String>
