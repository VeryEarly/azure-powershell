...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/stop-azvirtualmachine
schema: 2.0.0
---
...
### PowerOff (Default)
```
Stop-AzVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>] [-SkipShutdown]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### PowerOffViaIdentity
```
Stop-AzVirtualMachine -InputObject <IComputeClientIdentity> [-SkipShutdown] [-DefaultProfile <PSObject>]
