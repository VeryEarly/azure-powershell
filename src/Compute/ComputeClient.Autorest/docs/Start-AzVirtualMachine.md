...
online version: https://docs.microsoft.com/powershell/module/az.computeclient/start-azvirtualmachine
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzVirtualMachine -ResourceGroupName <String> -VMName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### StartViaIdentity
```
Start-AzVirtualMachine -InputObject <IComputeClientIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
