...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models
{
    ...
    public partial class ComputeIdentity
    {
        ...
        internal ComputeIdentity(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject json)
        {
            ...
            {_vMExtensionName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString>("vmExtensionName"), out var __jsonVMExtensionName) ? (string)__jsonVMExtensionName : (string)VMExtensionName;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._vMExtensionName)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Json.JsonString(this._vMExtensionName.ToString()) : null, "vmExtensionName" ,container.Add );
