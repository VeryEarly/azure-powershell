...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301
{
    ...
    public partial class PatchInstallationDetail :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetail,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.PatchInstallationState? _installationState;

        /// <summary>The state of the patch after the installation operation completed.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.PatchInstallationState? InstallationState { get => this._installationState; }
        ...
        string[] Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal.Classification { get => this._classification; set { {_classification = value;} } }

        /// <summary>Internal Acessors for InstallationState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.PatchInstallationState? Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal.InstallationState { get => this._installationState; set { {_installationState = value;} } }

        /// <summary>Internal Acessors for KbId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal.KbId { get => this._kbId; set { {_kbId = value;} } }

        /// <summary>Internal Acessors for Name</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal.Name { get => this._name; set { {_name = value;} } }

        /// <summary>Internal Acessors for PatchId</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal.PatchId { get => this._patchId; set { {_patchId = value;} } }

        /// <summary>Internal Acessors for Version</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IPatchInstallationDetailInternal.Version { get => this._version; set { {_version = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.PatchInstallationState) })]
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.PatchInstallationState? InstallationState { get;  }
        /// <summary>The KBID of the patch. Only applies to Windows patches.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
        Required = false,
        ReadOnly = true,
...

    {
        ...
        /// <summary>The state of the patch after the installation operation completed.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.PatchInstallationState? InstallationState { get; set; }
        /// <summary>The KBID of the patch. Only applies to Windows patches.</summary>
        string KbId { get; set; }
        /// <summary>The friendly name of the patch.</summary>
        string Name { get; set; }
