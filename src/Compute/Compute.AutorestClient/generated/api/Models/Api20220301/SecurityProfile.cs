...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301
{
    ...
    public partial class SecurityProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISecurityProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISecurityProfileInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettings Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISecurityProfileInternal.UefiSetting { get => (this._uefiSetting = this._uefiSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.UefiSettings()); set { {_uefiSetting = value;} } }

        /// <summary>Backing field for <see cref="SecurityType" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.SecurityTypes? _securityType;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.SecurityTypes? SecurityType { get => this._securityType; set => this._securityType = value; }

        /// <summary>Backing field for <see cref="UefiSetting" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettings _uefiSetting;
        ...
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettings UefiSetting { get => (this._uefiSetting = this._uefiSetting ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.UefiSettings()); set => this._uefiSetting = value; }
        ...
        public bool? UefiSettingSecureBootEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettingsInternal)UefiSetting).SecureBootEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettingsInternal)UefiSetting).SecureBootEnabled = value ?? default(bool); }

        /// <summary>
        /// Specifies whether vTPM should be enabled on the virtual machine. <br><br>Minimum api-version: 2020-12-01
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Inlined)]
        public bool? UefiSettingVTpmEnabled { get => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettingsInternal)UefiSetting).VTpmEnabled; set => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettingsInternal)UefiSetting).VTpmEnabled = value ?? default(bool); }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.SecurityTypes? SecurityType { get; set; }
        /// <summary>
        /// Specifies whether secure boot should be enabled on the virtual machine. <br><br>Minimum api-version: 2020-12-01
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Runtime.Info(
...

    {
        ...
        /// 2020-12-01
        /// </summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.IUefiSettings UefiSetting { get; set; }
        /// <summary>
        /// Specifies whether secure boot should be enabled on the virtual machine. <br><br>Minimum api-version: 2020-12-01
        /// </summary>
        bool? UefiSettingSecureBootEnabled { get; set; }
