...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301
{
    ...
    public partial class CapacityReservationProfile :
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ICapacityReservationProfile,
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ICapacityReservationProfileInternal
    {

        /// <summary>Backing field for <see cref="CapacityReservationGroup" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISubResource _capacityReservationGroup;
        ...
        internal Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISubResource CapacityReservationGroup { get => (this._capacityReservationGroup = this._capacityReservationGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.SubResource()); set => this._capacityReservationGroup = value; }

        /// <summary>Resource Id</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Compute.Origin(Microsoft.Azure.PowerShell.Cmdlets.Compute.PropertyOrigin.Inlined)]
        public string CapacityReservationGroupId { get => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISubResourceInternal)CapacityReservationGroup).Id; set => ((Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISubResourceInternal)CapacityReservationGroup).Id = value ?? null; }

        /// <summary>Internal Acessors for CapacityReservationGroup</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ISubResource Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.ICapacityReservationProfileInternal.CapacityReservationGroup { get => (this._capacityReservationGroup = this._capacityReservationGroup ?? new Microsoft.Azure.PowerShell.Cmdlets.Compute.Models.Api20220301.SubResource()); set { {_capacityReservationGroup = value;} } }
