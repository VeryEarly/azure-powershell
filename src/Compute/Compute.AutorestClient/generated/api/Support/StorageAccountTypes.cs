...
namespace Microsoft.Azure.PowerShell.Cmdlets.Compute.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes PremiumLrs = @"Premium_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes PremiumV2Lrs = @"PremiumV2_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes PremiumZrs = @"Premium_ZRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes StandardLrs = @"Standard_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes StandardSsdLrs = @"StandardSSD_LRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes StandardSsdZrs = @"StandardSSD_ZRS";

        public static Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes UltraSsdLrs = @"UltraSSD_LRS";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes e1, Microsoft.Azure.PowerShell.Cmdlets.Compute.Support.StorageAccountTypes e2)
        {
            return !e2.Equals(e1);
        }
